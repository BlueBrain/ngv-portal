      ...
      <DataContainer>
        <Collapsible title="Network level validation with respect to literature data">
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              <h3>Density</h3>
              <p>Astrocytes were placed according to the densities reported in <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0035169">Appaix et al. (2012)</a>, measuring an average density of 12241 mm<sup>-3</sup>, ranging from 9367 mm<sup>-3</sup> to 21479 mm<sup>-3</sup> close to the pia. The NGV framework accurately reproduced the density distribution for the selected profile</p>
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              <h3>Dispersion</h3>
              <p>Our placement algorithm reproduced the spacing between astrocytes, which results from their anatomically exclusive territories. We verified this orderly distribution using spatial analysis methods such as the pair correlation function and Ripley’s K-function.</p>
              <strong>Figure Legend:<br/></strong>
              <small>Spatial analysis of the point patterns corresponding to astrocytic somata. (A) Pair correlation function. (B) Ripley’s K-function. (C) Distance distribution from each astrocytic soma to its closest neighbor, compared to the input profile (orange) from Lopez-Hidalgo et al. 2016.</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              ...
              <p>The NGV framework produced domain volumes that corresponded to juvenile astrocytic densities, capturing the magnitude of the measurements encountered in the literature.</p>
              <strong>Figure legend:<br/></strong>
              <small>NGV microdomains analysis and validation. (A) Volume distribution of the regular (gray) and overlapping (orange) tessellations. (B) Comparison of NGV microdomain volumes (orange) with literature sources. (C) Per layer microdomain volume distributions and their respective box plots (red). (D) Scaling relationship between average microdomain volume and average astrocyte density.</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              <h3>Distance of astrocyte to vasculature</h3>
              <p>The shortest path length from the soma to the vasculature’s surface was measured to be 16 μm on average, which was in agreement with reported values (<a href="https://doi.org/10.3791/60225">Moye et al., 2019</a>). The relation between the surface area and thickness of the endfeet geometries validated that they agreed with the relationship from the study of (<a href="https://doi.org/10.1016/j.pneurobio.2019.101696">Calì et al., (2019)</a>).</p>
              <strong>Figure legend:<br/></strong>
              <small>Validation of astrocytic endfeet processes. (A) Shortest path length of the endfeet perivascular processes from the surface of the astrocytic soma to the surface of the vasculature. (B) Comparison of the average path length in the NGV (salmon) to the values reported by Moye et al., 2019 (turqoise). (C) Relationship between endfeet surface areas and thicknesses in the NGV circuit (salmon) and in the work of Cali et al., 2020 (turquoise).</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              <h3>Endfeet surface meshes</h3>
              <p>Studies using chemical fixation for their tissues reported a 70% − 100% coverage of the vasculature by perivascular endfeet. However, Korogod et al., (2015) showed that chemical fixation induces swelling of the astrocytic compartment, leading to increased coverage. They reported 62.9 ± 1.5% vascular coverage by astrocytic endfeet  using anatomy-preserving tissue fixation. We reproduced a ~60% (Figure 4L) vascular coverage by pruning the meshes using a Gaussian surface area distribution with a mean of 225 μm2 (<a href="https://doi.org/10.1016/j.pneurobio.2019.101696">Calì et al. 2019</a>).</p>
              <strong>Figure legend:<br/></strong>
              <small>Validation of astrocytic endfeet surface meshes (A) Endfeet surface area distribution. (B) Cumulative distribution comparison between the resulting surface areas and the target ones. (C) Coverage percentage of the vasculature surface (turquoise) by the endfeet areas (salmon).</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              ...
              <p>In the NGV circuit, the number of perivascular processes was constrained for juvenile rodents at 2 ± 1 processes. The number of primary processes in the NGV was measured as 8 ± 1 processes. We validated the spatial relationship between neurons and astrocytes, by measuring the distance to the closest neuronal soma. The distribution falls within the range of literature observations, that is from 5 µm to 30 µm for three types of inhibitory neurons  (<a href="https://doi.org/10.1002/glia.24044">Refaeli et al., 2020</a>).</p>
              <strong>Figure legend:<br/></strong>
              <small>Validation of astrocytic processes and association with neurons. (A) Average number of processes (primary and perisynaptic) per astrocyte for the NGV circuit (salmon) and literature sources (turquoise). (B) Histogram of the distances for each astrocytic soma to the closest neuronal soma.</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
        ...
        <Collapsible title="Synthesized Cell Validation" className="mt-4">
          ...
          <div className="row mt-4">
            <div className="col-xs-12 col-sm-6">
              <h3>Feature based</h3>
              <p>To validate the astrocytic component of the NGV circuit, we randomly selected six non-boundary synthesized astrocyte representatives from each layer. Morphometrics were extracted from these uniquely grown morphologies and were compared against those of the experimentally reconstructed astrocytes. The selection of morphometric features consisted of the number and length of sections, the section radial, path distances and branch orders, the remote bifurcation angles, and the segment radii and volumes.</p>
              <strong>Figure legend:<br/></strong>
              <small>Morphometric comparison between synthesized (orange) and experimental morphologies (blue).</small>
            </div>
            <div className="col-xs-12 col-sm-6">
              <ImageViewer
