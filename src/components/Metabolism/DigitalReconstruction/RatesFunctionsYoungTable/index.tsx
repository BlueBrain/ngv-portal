...
const data = require('@/../public/assets/files/metabolism/digital-reconstructions/rate_functions_young.json');
...
export default function RatesFunctionsYoungTable() {
  ...
  return (
    <>
      ...
      <div className="text-right mt-2">
        <HttpDownloadButton
          onClick={() => downloadAsJson(data, 'rate-functions-young-factsheet.json')}
        >
          rate functions
        </HttpDownloadButton>
      </div>
